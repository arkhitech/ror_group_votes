  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved logo as @logo" do
        ...
        post :create, {:logo => { "url" => "invalid value" }}, valid_session
        assigns(:logo).should be_a_new(Logo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested logo" do
        ...
        Logo.any_instance.should_receive(:update).with({ "url" => "MyString" })
        put :update, {:id => logo.to_param, :logo => { "url" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the logo as @logo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Logo.any_instance.stub(:save).and_return(false)
        put :update, {:id => logo.to_param, :logo => { "url" => "invalid value" }}, valid_session
        assigns(:logo).should eq(logo)
      end
